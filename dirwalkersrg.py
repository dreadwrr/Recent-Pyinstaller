...
def save_db(dbopt, dbtarget, basedir, CACHE_S, email, parsedsys, parsedidx, sys_records, keys=None, idx_drive=False, compLVL=200, iqt=False, dcr=False):
...
def index_drive(dbopt, dbtarget, basedir, parsedsys, parsedidx, dir_data, CACHE_S, error_message, email, idx_drive=False, compLVL=200, iqt=False, dcr=False):

    if save_db(dbopt, dbtarget, basedir, CACHE_S, email, parsedsys, parsedidx, None, None, idx_drive, compLVL, iqt, dcr):
        if dir_data:
